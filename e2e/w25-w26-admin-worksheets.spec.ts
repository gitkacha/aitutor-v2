  ...
  test('a saved math worksheet expands to show its questions, answers and explanations', async ({ page, request }) => {
    ...
    const save = await request.post('/api/math/worksheets/save', {
      data: {
        ...
        questions: [
          { questionText: `W25Q1 ${stamp}: what is 6 × 7?`, options: ['36', '42', '48', '54', '40'], correctIndex: 1, explanation: 'Six sevens are 42. The answer is Option B.', topicSlug: 'arithmetic' },
          { questionText: `W25Q2 ${stamp}: what is 81 ÷ 9?`, options: ['7', '8', '9', '10', '6'], correctIndex: 2, explanation: 'Nine nines are 81, so 81 ÷ 9 = 9. The answer is Option C.', topicSlug: 'arithmetic' },
        ],
      },
    });
